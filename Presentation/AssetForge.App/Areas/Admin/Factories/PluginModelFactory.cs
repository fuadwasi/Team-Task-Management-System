...
public partial class PluginModelFactory : IPluginModelFactory
{
    ...
    protected readonly ISiteMappingSupportedModelFactory _siteMappingSupportedModelFactory;
    ...
    public virtual async Task<PluginModel> PreparePluginModelAsync(PluginModel model, PluginDescriptor pluginDescriptor, bool excludeProperties = false)
    {
        ...
        if (pluginDescriptor != null)
        {
            ...
            model.SelectedSiteIds = pluginDescriptor.LimitedToSites;
        ...
        await _siteMappingSupportedModelFactory.PrepareModelSitesAsync(model);
    ...
    //    var currentVersionItem = searchModel.AvailableVersions.FirstOrDefault(x => x.Text.Contains(AssetForgeVersion.CURRENT_VERSION));
    ...
    public virtual async Task<IList<AdminNavigationPluginModel>> PrepareAdminNavigationPluginModelsAsync()
    {
        ...
        var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(PluginDefaults.AdminNavigationPluginsCacheKey, customer);
