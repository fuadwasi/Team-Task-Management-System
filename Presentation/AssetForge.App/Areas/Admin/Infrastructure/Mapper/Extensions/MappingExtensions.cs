...
namespace AssetForge.App.Areas.Admin.Infrastructure.Mapper.Extensions;
...
public static class MappingExtensions
{
    ...
    /// <returns>Mapped model</returns>
    public static TModel ToPluginModel<TModel>(this IPlugin plugin) where TModel : BaseModel, IPluginModel
    {
    ...
    public static TModel ToPluginModel<TModel>(this PluginDescriptor pluginDescriptor, TModel model = null)
        where TModel : BaseModel, IPluginModel
    {
