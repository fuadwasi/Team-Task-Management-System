...
public class AssetForgeApiController : Controller
{
    /// <summary>
    ...
    /// <returns></returns>
    public IActionResult OkWrap<T>(T baseModel, string message = null, IList<string> errors = null, bool defaultMessage = false) where T : BaseModel
    {
    ...
    /// <returns></returns>
    public IActionResult BadRequestWrap<T>(T baseModel, ModelStateDictionary modelState = null, IList<string> errors = null, bool showDefaultMessageIfEmpty = true) where T : BaseModel
    {
        var model = new GenericResponseModel<T>();
        model.Data = baseModel;
    ...
    /// <param name="defaultMessage">'true' value indicates it will send a default success message with the response.</param>
    /// <returns></returns>
    public IActionResult UnauthorizedWrap<T>(T baseModel, string error = null, IList<string> errors = null, bool defaultMessage = true) where T : BaseModel
    {
        var model = new GenericResponseModel<T>();
        model.Data = baseModel;
        if (!string.IsNullOrWhiteSpace(error))
    ...
    /// <param name="defaultMessage">'true' value indicates it will send a default success message with the response.</param>
    /// <returns></returns>
    public IActionResult NotFoundWrap<T>(T baseModel, string error = null, IList<string> errors = null, bool defaultMessage = true) where T : BaseModel
    {
        var model = new GenericResponseModel<T>();
        model.Data = baseModel;
        if (!string.IsNullOrWhiteSpace(error))
    ...
    /// <param name="defaultMessage">'true' value indicates it will send a default success message with the response.</param>
    /// <returns></returns>
    public IActionResult InternalServerErrorWrap<T>(T baseModel, string error = null, IList<string> errors = null, bool defaultMessage = true) where T : BaseModel
    {
        var model = new GenericResponseModel<T>();
        model.Data = baseModel;
        if (!string.IsNullOrWhiteSpace(error))
