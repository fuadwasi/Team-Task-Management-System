...
public partial class RouteProvider : BaseRouteProvider, IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        //set site theme
        endpointRouteBuilder.MapControllerRoute(name: "SetSiteTheme",
            pattern: $"{lang}/setsitetheme/{{themeName}}/{{returnUrl}}",
            defaults: new { controller = "Common", action = "SetSiteTheme" });
        ...
        //pages (AJAX)
        endpointRouteBuilder.MapControllerRoute(name: "PagePopup",
            pattern: $"t-popup/{{SystemName}}",
            defaults: new { controller = "Page", action = "PageDetailsPopup" });
        ...
        //authenticate page (AJAX)
        endpointRouteBuilder.MapControllerRoute(name: "PageAuthenticate",
            pattern: $"page/authenticate",
            defaults: new { controller = "Page", action = "Authenticate" });
        ...
        endpointRouteBuilder.MapControllerRoute(name: "PageEdit",
            pattern: $"{lang}/boards/pageedit/{{id:min(0)}}",
            defaults: new { controller = "Boards", action = "PageEdit" });

        endpointRouteBuilder.MapControllerRoute(name: "PageDelete",
            pattern: $"{lang}/boards/pagedelete/{{id:min(0)}}",
            defaults: new { controller = "Boards", action = "PageDelete" });

        endpointRouteBuilder.MapControllerRoute(name: "PageCreate",
            pattern: $"{lang}/boards/pagecreate/{{id:min(0)}}",
            defaults: new { controller = "Boards", action = "PageCreate" });

        endpointRouteBuilder.MapControllerRoute(name: "PageMove",
            pattern: $"{lang}/boards/pagemove/{{id:min(0)}}",
            defaults: new { controller = "Boards", action = "PageMove" });

        //page watch (AJAX)
        endpointRouteBuilder.MapControllerRoute(name: "PageWatch",
            pattern: $"boards/pagewatch/{{id:min(0)}}",
            defaults: new { controller = "Boards", action = "PageWatch" });

        endpointRouteBuilder.MapControllerRoute(name: "PageSlug",
            pattern: $"{lang}/boards/page/{{id:min(0)}}/{{slug?}}",
            defaults: new { controller = "Boards", action = "Page" });

        endpointRouteBuilder.MapControllerRoute(name: "PageSlugPaged",
            pattern: $"{lang}/boards/page/{{id:min(0)}}/{{slug?}}/page/{{pageNumber:int}}",
            defaults: new { controller = "Boards", action = "Page" });
        ...
        //site closed
        endpointRouteBuilder.MapControllerRoute(name: "SiteClosed",
            pattern: $"{lang}/siteclosed",
            defaults: new { controller = "Common", action = "SiteClosed" });

        //install
        endpointRouteBuilder.MapControllerRoute(name: "Installation",
            pattern: $"{AssetForgeInstallationDefaults.InstallPath}",
            defaults: new { controller = "Install", action = "Index" });

        endpointRouteBuilder.MapControllerRoute(name: "InstallationChangeLanguage",
            pattern: $"{AssetForgeInstallationDefaults.InstallPath}/ChangeLanguage/{{language}}",
        ...
        endpointRouteBuilder.MapControllerRoute(name: "InstallationRestartApplication",
            pattern: $"{AssetForgeInstallationDefaults.InstallPath}/restartapplication",
