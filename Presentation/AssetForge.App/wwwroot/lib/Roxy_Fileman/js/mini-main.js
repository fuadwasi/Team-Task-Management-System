...
function previewFile(){
  var f = getSelectedFile();
  if(f){
    window.open(RoxyFilemanConf.RETURN_URL_PREFAssetForge + f.fullPath);
  }
}
...
function getPreselectedFile(){
  ...
  if(RoxyFilemanConf.RETURN_URL_PREFAssetForge){
    var prefix = RoxyFilemanConf.RETURN_URL_PREFAssetForge;
