...
$(function() {
    $('.multi-site-override-option').each(function (k, v) {
        checkOverriddenSiteValue(v, $(v).attr('data-for-input-selector'));
    });
...
function checkAllOverriddenSiteValue(item) {
    $('.multi-site-override-option').each(function (k, v) {
...
function checkOverriddenSiteValue(obj, selector) {
...
$(function() {
  ...
  $('#ixSideBarPusher').on('click', function (e) {
    reloadAllDataTables();
  });
});
