...
/// </summary>
public static partial class RoutingDefaults
{
    #region Route names
    ...
    public static partial class RouteName
    {
        public static partial class Generic
        {
            ...
            /// <summary>
            /// Gets the generic page route name
            /// </summary>
            public static string Page => "PageDetails";
    ...
    public static partial class RouteValue
    {
        ...
        /// <summary>
        /// Gets default key for page id route value
        /// </summary>
