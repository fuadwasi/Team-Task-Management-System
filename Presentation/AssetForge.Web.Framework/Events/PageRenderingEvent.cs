...
namespace AssetForge.Web.Framework.Events;
...
public partial class PageRenderingEvent
{
    ...
    public PageRenderingEvent(IAssetForgeHtmlHelper helper, string overriddenRouteName = null)
    {
        Helper = helper;
    ...
    /// Gets HTML helper
    /// </summary>
    public IAssetForgeHtmlHelper Helper { get; protected set; }
