...
namespace AssetForge.Web.Framework.Components;

/// <summary>
/// Base class for ViewComponent in AssetForge
/// </summary>
public abstract partial class AssetForgeViewComponent : ViewComponent
{
    protected virtual void PublishModelPrepared<TModel>(TModel model)
    {
        ...
        if (model is BaseModel)
        {
            ...
            eventPublisher.ModelPreparedAsync(model as BaseModel).Wait();
        }
