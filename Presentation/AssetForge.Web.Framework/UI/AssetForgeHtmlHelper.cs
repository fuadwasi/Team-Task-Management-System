...
namespace AssetForge.Web.Framework.UI;

/// <summary>
/// Represents the HTML helper implementation
/// </summary>
public partial class AssetForgeHtmlHelper : IAssetForgeHtmlHelper
{
    #region Fields
    ...
    protected readonly IAssetHelper _bundleHelper;
    ...
    public AssetForgeHtmlHelper(AppSettings appSettings,
        HtmlEncoder htmlEncoder,
        IActionContextAccessor actionContextAccessor,
        IAssetHelper bundleHelper,
    ...
    public virtual async Task<IHtmlContent> GenerateTitleAsync(bool addDefaultTitle = true, string part = "")
    {
        ...
        var defaultTitle = await _localizationService.Value.GetLocalizedAsync(site, s => s.DefaultTitle);
    ...
    public virtual async Task<IHtmlContent> GenerateMetaDescriptionAsync(string part = "")
    {
        ...
        var result = !string.IsNullOrEmpty(metaDescription)
            ? metaDescription
            : await _localizationService.Value.GetLocalizedAsync(await _siteContext.GetCurrentSiteAsync(),
    ...
    public virtual string GetRouteName(bool handleDefaultRoutes = false)
    {
        ...
        if (httpContext.GetRouteValue(RoutingDefaults.RouteValue.SeName) is not null &&
            httpContext.GetRouteValue(RoutingDefaults.RouteValue.Action) is string actionName)
            return actionName;
