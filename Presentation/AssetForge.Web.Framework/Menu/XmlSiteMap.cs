...
/// XML sitemap
/// </summary>
public partial class XmlSiteMap : AssetForgemlSiteMap
{
    #region Fields
    ...
    protected virtual async Task PopulateNodeAsync(SiteMapNode siteMapNode, XmlNode xmlNode)
    {
        ...
        //title
        var ixResource = GetStringValueFromAttribute(xmlNode, "ixResource");
        siteMapNode.Title = await _localizationService.GetResourceAsync(ixResource);
        ...
        if (!string.IsNullOrEmpty(controllerName) && !string.IsNullOrEmpty(actionName))
        {
            ...
            //apply admin area as described here - https://www.ixcommerce.com/boards/page/20478/broken-menus-in-admin-area-whilst-trying-to-make-a-plugin-admin-page
