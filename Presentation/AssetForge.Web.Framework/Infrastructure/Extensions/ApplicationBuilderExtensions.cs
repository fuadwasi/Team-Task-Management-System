...
namespace AssetForge.Web.Framework.Infrastructure.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeExceptionHandler(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeResponseCompression(this IApplicationBuilder application)
        {
            if (!DataSettingsManager.IsDatabaseInstalled())
                return;
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeWebOptimizer(this IApplicationBuilder application)
        {
            ...
            var fileProvider = EngineContext.Current.Resolve<Core.Infrastructure.IAssetForgeFileProvider>();
            var webHostEnvironment = EngineContext.Current.Resolve<IWebHostEnvironment>();
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeStaticFiles(this IApplicationBuilder application)
        {
            var fileProvider = EngineContext.Current.Resolve<Core.Infrastructure.IAssetForgeFileProvider>();
            var appSettings = EngineContext.Current.Resolve<AppSettings>();
            ...
            {
                FileProvider = new PhysicalFileProvider(fileProvider.GetAbsolutePath(SeoDefaults.SitemapXmlDirectory)),
                RequestPath = new PathString($"/{SeoDefaults.SitemapXmlDirectory}"),
            ...
            application.UseStaticFiles(new StaticFileOptions
            {
                FileProvider = new PhysicalFileProvider(fileProvider.GetAbsolutePath(CommonDefaults.DbBackupsPath)),
            ...
            if (DataSettingsManager.IsDatabaseInstalled())
            {
                application.UseStaticFiles(new StaticFileOptions
                {
                    ...
                    RequestPath = new PathString(RoxyFilemanDefaults.DefaultRootDirectory),
                    OnPrepareResponse = staticFileResponse
                });
            }
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeAuthentication(this IApplicationBuilder application)
        {
            //check whether database is installed
            if (!DataSettingsManager.IsDatabaseInstalled())
                return;
        ...
        /// Configure PDF
        /// </summary>
        public static void UseAssetForgePdf(this IApplicationBuilder _)
        {
            if (!DataSettingsManager.IsDatabaseInstalled())
                return;
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeRequestLocalization(this IApplicationBuilder application)
        {
            application.UseRequestLocalization(options =>
            {
                ...
                options.DefaultRequestCulture = new RequestCulture(cultures.FirstOrDefault() ?? new CultureInfo(CommonDefaults.DefaultLanguageCulture));
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeEndpoints(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeProxy(this IApplicationBuilder application)
        {
            var appSettings = EngineContext.Current.Resolve<AppSettings>();
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAssetForgeWebMarkupMin(this IApplicationBuilder application)
        {
            //check whether database is installed
            if (!DataSettingsManager.IsDatabaseInstalled())
                return;
