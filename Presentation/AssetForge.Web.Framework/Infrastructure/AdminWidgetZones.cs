...
public static partial class AdminWidgetZones
{
    ...
    public static string WidgetAttributeCombinationDetailsBottom => "admin_widget_attribute_combination_details_bottom";
    public static string WidgetAttributeCombinationDetailsButtons => "admin_widget_attribute_combination_details_buttons";
    public static string WidgetAttributeCombinationDetailsTop => "admin_widget_attribute_combination_details_top";
    public static string WidgetAttributeDetailsBlock => "admin_widget_attribute_details_block";
    public static string WidgetAttributeDetailsButtons => "admin_widget_attribute_details_buttons";
    public static string WidgetAttributeListButtons => "admin_widget_attribute_list_buttons";
    public static string WidgetAttributeMappingDetailsBlock => "admin_widget_attribute_mapping_details_block";
    public static string WidgetAttributeMappingDetailsButtons => "admin_widget_attribute_mapping_details_buttons";
    public static string WidgetAttributePredefinedValueDetailsButtons => "admin_widget_attribute_predefined_value_details_buttons";
    public static string WidgetAttributePredefinedValuesDetailsBottom => "admin_widget_attribute_predefined_values_details_bottom";
    public static string WidgetAttributePredefinedValuesDetailsTop => "admin_widget_attribute_predefined_values_details_top";
    public static string WidgetAttributeValueDetailsBottom => "admin_widget_attribute_value_details_bottom";
    public static string WidgetAttributeValueDetailsButtons => "admin_widget_attribute_value_details_buttons";
    public static string WidgetAttributeValueDetailsTop => "admin_widget_attribute_value_details_top";
    ...
    public static string ProductDetailsWidgetAttributesCombinationsBottom => "admin_product_details_widget_attributes_combinations_bottom";
    public static string ProductDetailsWidgetAttributesCombinationsTop => "admin_product_details_widget_attributes_combinations_top";
    public static string ProductDetailsWidgetAttributesInfoBottom => "admin_product_details_widget_attributes_info_bottom";
    public static string ProductDetailsWidgetAttributesInfoTop => "admin_product_details_widget_attributes_info_top";
    ...
    public static string PageDetailsBlock => "admin_page_details_block";
    public static string PageDetailsButtons => "admin_page_details_buttons";
    public static string PageListButtons => "admin_page_list_buttons";
    public static string PageTemplateListButtons => "admin_page_template_list_buttons";
