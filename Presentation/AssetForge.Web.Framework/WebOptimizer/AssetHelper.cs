...
using AssetForge.Web.Framework.WebOptimizer.Processors;
...
/// </summary>
public partial class AssetHelper : IAssetHelper
{
    #region Fields
    ...
    public AssetHelper(AppSettings appSettings, IActionContextAccessor actionContextAccessor, IAssetPipeline assetPipeline)
    {
    ...
    public IAsset GetOrCreateJavaScriptAsset(string bundleKey, params string[] sourceFiles)
    {
        ...
        if (!_assetPipeline.TryGetAssetFromRoute(bundleKey, out var asset))
        {
            ...
            asset.Processors.Add(new JsMinifier());
    ...
    public IAsset GetOrCreateCssAsset(string bundleKey, params string[] sourceFiles)
    {
        ...
        if (!_assetPipeline.TryGetAssetFromRoute(bundleKey, out var asset))
        {
            ...
            //to more precisely log problem files we minify them before concatenating
            asset.Processors.Add(new CssMinifier());
