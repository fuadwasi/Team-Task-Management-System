...
namespace AssetForge.Web.Framework.Security.Captcha;
...
public partial class CaptchaHttpClient
{
        ...
        IWebHelper webHelper)
    {
        ...
        client.DefaultRequestHeaders.Add(HeaderNames.UserAgent, $"AssetForgeCms-{AssetForgeVersion.CURRENT_VERSION}");
    ...
    public virtual async Task<CaptchaResponse> ValidateCaptchaAsync(string responseValue)
    {
        ...
        var url = string.Format(SecurityDefaults.RecaptchaValidationPath,
