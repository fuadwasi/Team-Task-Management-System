...
namespace AssetForge.Web.Framework.Security;
...
public static class FilePermissionHelper
{
    ...
    [SupportedOSPlatform("windows")]
    private static bool CheckPermissionsInWindows(IAssetForgeFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
    {
    ...
    /// <param name="checkDelete">Check delete</param>
    /// <returns>Result</returns>
    public static bool CheckPermissions(this IAssetForgeFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
    {
    ...
    /// </summary>
    /// <returns>Result</returns>
    public static IEnumerable<string> GetDirectoriesWrite(this IAssetForgeFileProvider fileProvider)
    {
    ...
    /// </summary>
    /// <returns>Result</returns>
    public static IEnumerable<string> GetFilesWrite(this IAssetForgeFileProvider fileProvider)
    {
        return new List<string>
        {
            fileProvider.MapPath(PluginDefaults.PluginsInfoFilePath),
            fileProvider.MapPath(ConfigurationDefaults.AppSettingsFilePath)
        };
    }
