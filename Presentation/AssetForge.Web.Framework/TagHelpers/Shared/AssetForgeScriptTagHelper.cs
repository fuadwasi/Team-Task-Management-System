...
namespace AssetForge.Web.Framework.TagHelpers.Shared;

/// <summary>
/// Script bundling tag helper
/// </summary>
[HtmlTargetElement(SCRIPT_TAG_NAME)]
public partial class AssetForgeScriptTagHelper : UrlResolutionTagHelper
{
    #region Constants
    ...
    protected readonly IAssetForgeHtmlHelper _iXHtmlHelper;
    ...
    public AssetForgeScriptTagHelper(AppSettings appSettings,
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (string.IsNullOrEmpty(Src))
            _iXHtmlHelper.AddInlineScriptParts(Location, await BuildInlineScriptTagAsync(output));
        else
            _iXHtmlHelper.AddScriptParts(Location, Src, DebugSrc, ExcludeFromBundle);
