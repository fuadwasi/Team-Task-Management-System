...
[HtmlTargetElement("ix-date-picker", Attributes = DAY_NAME_ATTRIBUTE_NAME + "," + MONTH_NAME_ATTRIBUTE_NAME + "," + YEAR_NAME_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeDatePickerTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper, ILocalizationService localizationService)
    {
        Generator = generator;
