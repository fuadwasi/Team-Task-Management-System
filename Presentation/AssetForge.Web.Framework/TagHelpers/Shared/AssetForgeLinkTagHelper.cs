...
public partial class AssetForgeLinkTagHelper : UrlResolutionTagHelper
{
    #region Constants
    ...
    public AssetForgeLinkTagHelper(HtmlEncoder htmlEncoder,
    ...
    public override Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        _iXHtmlHelper.AddCssFileParts(Href, string.Empty, ExcludeFromBundle);
