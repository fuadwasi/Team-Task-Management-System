...
/// <summary>
/// "ix-override-site-checkbox" tag helper
/// </summary>
[HtmlTargetElement("ix-override-site-checkbox", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeOverrideSiteCheckboxHelper : TagHelper
{
    #region Constants
    ...
    protected const string SITE_SCOPE_ATTRIBUTE_NAME = "asp-site-scope";
    ...
    public AssetForgeOverrideSiteCheckboxHelper(IHtmlHelper htmlHelper)
    {
    ...
    ///The site scope
    /// </summary>
    [HtmlAttributeName(SITE_SCOPE_ATTRIBUTE_NAME)]
