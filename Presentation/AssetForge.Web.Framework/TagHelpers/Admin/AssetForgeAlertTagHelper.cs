...
/// "ix-alert" tag helper
/// </summary>
[HtmlTargetElement("ix-alert", Attributes = ALERT_NAME_ID, TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeAlertTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeAlertTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
    {
        Generator = generator;
