...
/// "ix-tabs" tag helper
/// </summary>
[HtmlTargetElement("ix-tabs", Attributes = ID_ATTRIBUTE_NAME)]
public partial class AssetForgeTabsTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeTabsTagHelper(IHtmlHelper htmlHelper)
    {
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        //create context item
        var tabContext = new List<AssetForgeTabContextItem>();
        context.Items.Add(typeof(AssetForgeTabsTagHelper), tabContext);
