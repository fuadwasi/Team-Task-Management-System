...
/// <summary>
/// "ix-doc-reference" tag helper
/// </summary>
[HtmlTargetElement("ix-doc-reference", Attributes = STRING_RESOURCE_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeDocReferenceTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeDocReferenceTagHelper(AdminAreaSettings adminAreaSettings)
    {
