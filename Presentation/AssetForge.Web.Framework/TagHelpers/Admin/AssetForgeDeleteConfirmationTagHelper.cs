...
/// <summary>
/// "ix-delete-confirmation" tag helper
/// </summary>
[HtmlTargetElement("ix-delete-confirmation", Attributes = MODEL_ID_ATTRIBUTE_NAME + "," + BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeDeleteConfirmationTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
    {
        Generator = generator;
