...
/// <summary>
/// "ix-textarea" tag helper
/// </summary>
[HtmlTargetElement("ix-textarea", Attributes = FOR_ATTRIBUTE_NAME)]
public partial class AssetForgeTextAreaTagHelper : TextAreaTagHelper
{
    #region Constants
    ...
    public AssetForgeTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
    {
    }
