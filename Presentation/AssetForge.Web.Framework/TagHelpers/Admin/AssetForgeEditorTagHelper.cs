...
/// <summary>
/// "ix-editor" tag helper
/// </summary>
[HtmlTargetElement("ix-editor", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeEditorTagHelper : TagHelper
{
    #region Constants
    ...
    protected const string POSTFAssetForge_ATTRIBUTE_NAME = "asp-postfix";
    ...
    public AssetForgeEditorTagHelper(IHtmlHelper htmlHelper)
    {
    ...
    /// Postfix
    /// </summary>
    [HtmlAttributeName(POSTFAssetForge_ATTRIBUTE_NAME)]
