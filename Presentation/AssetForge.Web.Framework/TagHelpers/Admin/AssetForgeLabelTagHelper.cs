...
/// "ix-label" tag helper
/// </summary>
[HtmlTargetElement("ix-label", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeLabelTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeLabelTagHelper(IHtmlGenerator generator, ILocalizationService localizationService, IWorkContext workContext)
    {
        Generator = generator;
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (type != null && !string.IsNullOrEmpty(propertyName))
        {
            resourceName = type.GetProperty(propertyName)
                ?.GetCustomAttributes(typeof(ResourceDisplayNameAttribute), true)
