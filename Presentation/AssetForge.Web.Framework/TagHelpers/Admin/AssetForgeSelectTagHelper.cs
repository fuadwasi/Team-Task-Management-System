...
/// <summary>
/// "ix-select" tag helper
/// </summary>
[HtmlTargetElement("ix-select", TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeSelectTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeSelectTagHelper(IHtmlHelper htmlHelper)
    {
