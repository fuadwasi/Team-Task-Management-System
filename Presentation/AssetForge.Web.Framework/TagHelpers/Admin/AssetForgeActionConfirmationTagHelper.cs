...
/// <summary>
/// "ix-action-confirmation" tag helper
/// </summary>
[HtmlTargetElement("ix-action-confirmation", Attributes = BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
public partial class AssetForgeActionConfirmationTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
    {
        Generator = generator;
