...
using AssetForge.Web.Framework.Infrastructure;
...
/// "ix-card" tag helper
/// </summary>
[HtmlTargetElement("ix-card", Attributes = NAME_ATTRIBUTE_NAME)]
public partial class AssetForgeCardTagHelper : TagHelper
{
    #region Constants
