...
/// <summary>
/// "ix-nested-setting" tag helper
/// </summary>
[HtmlTargetElement("ix-nested-setting", Attributes = FOR_ATTRIBUTE_NAME)]
public partial class AssetForgeNestedSettingTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeNestedSettingTagHelper(IHtmlGenerator generator)
    {
        Generator = generator;
    }
