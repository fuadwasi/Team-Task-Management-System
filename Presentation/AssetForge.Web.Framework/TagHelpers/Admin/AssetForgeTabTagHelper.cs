...
/// "ix-tab" tag helper
/// </summary>
[HtmlTargetElement("ix-tab", ParentTag = "ix-tabs", Attributes = NAME_ATTRIBUTE_NAME)]
public partial class AssetForgeTabTagHelper : TagHelper
{
    #region Constants
    ...
    public AssetForgeTabTagHelper(IHtmlHelper htmlHelper)
    {
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        //add to context
        var tabContext = (List<AssetForgeTabContextItem>)context.Items[typeof(AssetForgeTabsTagHelper)];
        tabContext.Add(new AssetForgeTabContextItem
        {
