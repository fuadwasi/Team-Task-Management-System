...
using AssetForge.Data.Mapping.Builders;
using LinqToDB.Mapping;
using System.ComponentModel.DataAnnotations.Schema;
using System.Data;
using System.Reflection;

namespace AssetForge.Data.Extensions
{
    /// <summary>
    ...
    public static class FluentMigratorExtensions
    {
        ...
        private static Dictionary<Type, Action<ICreateTableColumnAsTypeSyntax>> TypeMapping { get; } = new Dictionary<Type, Action<ICreateTableColumnAsTypeSyntax>>
        {
            ...
            [typeof(DateTime)] = c => c.AsAssetForgeDateTime2(),
        ...
        /// </summary>
        public static ICreateTableColumnOptionOrWithColumnSyntax AsAssetForgeDateTime2(this ICreateTableColumnAsTypeSyntax syntax)
        {
