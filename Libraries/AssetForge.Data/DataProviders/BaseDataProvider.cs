...
public abstract partial class BaseDataProvider
{
    ...
    protected virtual DataConnection CreateDataConnection(global::LinqToDB.DataProvider.IDataProvider dataProvider)
    {
        ArgumentNullException.ThrowIfNull(dataProvider);

        var dataConnection = new DataConnection(dataProvider, CreateDbConnection(), MappingSchema.GetMappingSchema(ConfigurationName, LinqToDbDataProvider))
        {
    ...
    /// </summary>
    /// <param name="siteKey">Name of temporary storage</param>
    ...
    /// </returns>
    public virtual Task<ITempDataStorage<TItem>> CreateTempDataStorageAsync<TItem>(string siteKey, IQueryable<TItem> query)
        where TItem : class
    {
        return Task.FromResult<ITempDataStorage<TItem>>(new TempSqlDataStorage<TItem>(siteKey, query, CreateDataConnection()));
    }



    /// <summary>
    /// Get hash values of a sited entity field
    /// </summary>
    ...
    public virtual IQueryable<TEntity> GetTable<TEntity>() where TEntity : BaseEntity
    {
        var options = new DataOptions()
            ...
            .UseMappingSchema(MappingSchema.GetMappingSchema(ConfigurationName, LinqToDbDataProvider));
    ...
    /// <summary>
    /// Executes command using System.Data.CommandType.SitedProcedure command type and
    ...
    /// </summary>
    protected abstract global::LinqToDB.DataProvider.IDataProvider LinqToDbDataProvider { get; }
