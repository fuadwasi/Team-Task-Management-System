...
public partial class MySqlAssetForgeDataProvider : BaseDataProvider, IDataProvider
{
    #region Fields
    ...
    public virtual async Task<int?> GetTableIdentAsync<TEntity>() where TEntity : BaseEntity
    {
        ...
        var tableName = MappingSchema.GetEntityDescriptor(typeof(TEntity)).EntityName;
    ...
    public virtual string BuildConnectionString(IConnectionStringInfo AssetForgeConnectionString)
    {
        ...
        {
            Server = AssetForgeConnectionString.ServerName,
            ...
            UserID = AssetForgeConnectionString.Username,
    ...
    {
        return "AssetForge_" + HashHelper.CreateHash(Encoding.UTF8.GetBytes($"{targetTable}_{targetColumn}"), HASH_ALGORITHM);
    }
    ...
    /// MySql data provider
    /// </summary>
    protected override global::LinqToDB.DataProvider.IDataProvider LinqToDbDataProvider => MySqlTools.GetDataProvider(ProviderName.MySqlConnector);
