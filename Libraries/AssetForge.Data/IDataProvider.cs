...
public partial interface IDataProvider
{
    ...
    /// </returns>
    Task<ITempDataStorage<TItem>> CreateTempDataStorageAsync<TItem>(string siteKey, IQueryable<TItem> query)
        where TItem : class;
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    Task ResiteDatabaseAsync(string backupFileName);
    ...
    string BuildConnectionString(IConnectionStringInfo AssetForgeConnectionString);
