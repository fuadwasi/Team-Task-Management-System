...
public partial class CommonConfig : IConfig
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether to Site TempData in the session state. By default the cookie-based TempData provider is used to Site TempData in cookies.
    /// </summary>
