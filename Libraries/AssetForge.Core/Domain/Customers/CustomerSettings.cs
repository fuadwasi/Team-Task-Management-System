...
public partial class CustomerSettings : ISettings
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether 'New customer' notification message should be sent to a Site owner
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating we should Site last visited page URL for each customer
    /// </summary>
    public bool SiteLastVisitedPage { get; set; }

    /// <summary>
    /// Gets or sets a value indicating we should Site IP addresses of customers
    /// </summary>
