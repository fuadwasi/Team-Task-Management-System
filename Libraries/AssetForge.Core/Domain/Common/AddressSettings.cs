...
namespace AssetForge.Core.Domain.Common;
...
public partial class AddressSettings : ISettings
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether we have to preselect a country if there's only one country available (public Site)
    /// </summary>
