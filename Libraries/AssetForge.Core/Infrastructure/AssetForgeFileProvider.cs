...
{
    public partial class AssetForgeFileProvider : PhysicalFileProvider, IAssetForgeFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a AssetForgeFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public AssetForgeFileProvider(IWebHostEnvironment webHostEnvironment) : base(File.Exists(webHostEnvironment.ContentRootPath) ? Path.GetDirectoryName(webHostEnvironment.ContentRootPath) : webHostEnvironment.ContentRootPath)
        {
        ...
        public virtual string Combine(params string[] paths)
        {
            ...
            if (Environment.OSVersion.Platform == PlatformID.Unix && !IsUncPath(path))
                //add leading slash to correctly form path in the UNAssetForge system
                path = "/" + path;
