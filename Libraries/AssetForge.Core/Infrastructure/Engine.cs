...
namespace AssetForge.Core.Infrastructure
{
    ...
    public partial class Engine : IEngine
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var typeFinder = Singleton<ITypeFinder>.Instance;
            var startupConfigurations = typeFinder.FindClassesOfType<IAssetForgeStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations.Select(startup => (IAssetForgeStartup)Activator.CreateInstance(startup)).Where(startup => startup != null).OrderBy(startup => startup.Order);
        ...
        public virtual void ConfigureRequestPipeline(IApplicationBuilder application)
        {
            ...
            var instances = startupConfigurations
                .Select(startup => (IAssetForgeStartup)Activator.CreateInstance(startup))
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
                try
                {
                    ...
                    {
                        var service = Resolve(parameter.ParameterType) ?? throw new AssetForgeException("Unknown dependency");
                        return service;
                    });
            ...
            throw new AssetForgeException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
