...
public partial interface IMultiFactorAuthenticationPluginManager : IPluginManager<IMultiFactorAuthenticationMethod>
{
    ...
    /// </returns>
    Task<bool> HasActivePluginsAsync(Customer customer = null, int siteId = 0);
    ...
    /// </returns>
    Task<IList<IMultiFactorAuthenticationMethod>> LoadActivePluginsAsync(Customer customer = null, int siteId = 0);
    ...
    /// </returns>
    Task<bool> IsPluginActiveAsync(string systemName, Customer customer = null, int siteId = 0);
}