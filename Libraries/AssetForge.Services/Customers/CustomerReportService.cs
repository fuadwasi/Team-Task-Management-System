using IX.Core;
using IX.Core.Domain.Customers;
using IX.Core.Domain.Payments;
using IX.Data;
using IX.Services.Helpers;


namespace IX.Services.Customers;
...
public partial class CustomerReportService : ICustomerReportService
{
    ...
    public virtual async Task<int> GetRegisteredCustomersReportAsync(int days)
    {
        ...
        var registeredCustomerRole = await _customerService.GetCustomerRoleBySystemNameAsync(IXCustomerDefaults.RegisteredRoleName);
