...
public partial class CustomerAddressMappingCacheEventConsumer : CacheEventConsumer<CustomerAddressMapping>
{
    ...
    {
        await RemoveAsync(AssetForgeCustomerServicesDefaults.CustomerAddressesCacheKey, entity.CustomerId);

        if (entityEventType == EntityEventType.Delete)
            await RemoveAsync(AssetForgeCustomerServicesDefaults.CustomerAddressCacheKey, entity.CustomerId, entity.AddressId);
