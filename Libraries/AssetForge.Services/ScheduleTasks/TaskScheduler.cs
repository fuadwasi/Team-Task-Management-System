...
namespace AssetForge.Services.ScheduleTasks
{
    /// <summary>
    ...
    public partial class TaskScheduler : ITaskScheduler
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            var scheduleTaskUrl = $"{site.Url.TrimEnd('/')}/{TaskDefaults.ScheduleTaskPath}";
        ...
        protected partial class TaskThread : IDisposable
        {
            ...
            private async Task RunAsync()
            {
                ...
                catch (Exception ex)
                {
                    ...
                    var siteContext = EngineContext.Current.Resolve<ISiteContext>(scope);
