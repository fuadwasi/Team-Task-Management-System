...
namespace AssetForge.Services.Configuration
{
    ...
    public partial interface ISettingService
    {
        ...
        /// The task result contains the setting
        /// </returns>
        Task<Setting> GetSettingAsync(string key, int siteId = 0, bool loadSharedValueIfNotFound = false);
        ...
        /// The setting
        /// </returns>
        Setting GetSetting(string key, int siteId = 0, bool loadSharedValueIfNotFound = false);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SetSettingAsync<T>(string key, T value, int siteId = 0, bool clearCache = true);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task<T> LoadSettingAsync<T>(int siteId = 0) where T : ISettings, new();
        ...
        /// <param name="siteId">Site identifier for which settings should be loaded</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task<ISettings> LoadSettingAsync(Type type, int siteId = 0);
        ...
        /// <param name="siteId">Site identifier for which settings should be loaded</param>
        /// <returns>Settings</returns>
        ISettings LoadSetting(Type type, int siteId = 0);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SaveSettingAsync<T>(T settings, int siteId = 0) where T : ISettings, new();
        ...
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SaveSettingOverridablePerSiteAsync<T, TPropType>(T settings,
            Expression<Func<T, TPropType>> keySelector,
