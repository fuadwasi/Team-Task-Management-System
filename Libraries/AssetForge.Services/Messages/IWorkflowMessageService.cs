...
public partial interface IWorkflowMessageService
{
    ...
    /// </returns>
    Task<IList<int>> SendCustomerRegisteredSiteOwnerNotificationMessageAsync(Customer customer, int languageId);
    ...
    /// The task result contains the queued email identifier
    /// </returns>
    Task<IList<int>> SendDeleteCustomerRequestSiteOwnerNotificationAsync(Customer customer, int languageId);
