...
public partial interface IMessageTemplateService
{
    ...
    /// </returns>
    Task<IList<MessageTemplate>> GetMessageTemplatesByNameAsync(string messageTemplateName, int? siteId = null);
    ...
    /// </returns>
    Task<IList<MessageTemplate>> GetAllMessageTemplatesAsync(int siteId, string keywords = null, bool? isActive = null);
