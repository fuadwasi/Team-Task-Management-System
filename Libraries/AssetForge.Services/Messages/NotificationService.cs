...
public partial class NotificationService : INotificationService
{
    ...
    protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
    {
        ...
        //Messages have sited in a serialized list
        var messages = tempData.TryGetValue(AssetForgeMessageDefaults.NotificationListKey, out var value)
        ...
        tempData[AssetForgeMessageDefaults.NotificationListKey] = JsonConvert.SerializeObject(messages);
    }
