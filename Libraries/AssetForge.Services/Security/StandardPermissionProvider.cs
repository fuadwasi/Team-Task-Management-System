...
public partial class StandardPermissionProvider : IPermissionProvider
{
    ...
    public static readonly PermissionRecord ManageLayouts = new() { Name = "Admin area. Manage Layouts", SystemName = "ManageLayouts", Category = "Content Management" };
    public static readonly PermissionRecord ManagePages = new() { Name = "Admin area. Manage Pages", SystemName = "ManagePages", Category = "Content Management" };
    ...
    public static readonly PermissionRecord DisplayPrices = new() { Name = "Public site. Display Prices", SystemName = "DisplayPrices", Category = "PublicSite" };
    public static readonly PermissionRecord EnableShoppingCart = new() { Name = "Public site. Enable shopping cart", SystemName = "EnableShoppingCart", Category = "PublicSite" };
    public static readonly PermissionRecord EnableWishlist = new() { Name = "Public site. Enable wishlist", SystemName = "EnableWishlist", Category = "PublicSite" };
    ...
    public virtual HashSet<(string systemRoleName, PermissionRecord[] permissions)> GetDefaultPermissions()
    {
        return new HashSet<(string, PermissionRecord[])>
        {
            ...
            (
                CustomerDefaults.ForumModeratorsRoleName,
                new[]
                {
                    DisplayPrices,
                    EnableShoppingCart,
