...
public partial class PermissionService : IPermissionService
{
    ...
    {
        var key = _staticCacheManager.PrepareKeyForDefaultCache(SecurityDefaults.PermissionRecordsAllCacheKey, customerRoleId);
    ...
    public virtual async Task<bool> AuthorizeAsync(string permissionRecordSystemName, int customerRoleId)
    {
        ...
        var key = _staticCacheManager.PrepareKeyForDefaultCache(SecurityDefaults.PermissionAllowedCacheKey, permissionRecordSystemName, customerRoleId);
