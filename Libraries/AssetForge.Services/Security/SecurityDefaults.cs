...
public static partial class SecurityDefaults
{
    ...
    /// {1} : entity name
    /// </remarks>
    public static CacheKey AclRecordCacheKey => new("AssetForge.aclrecord.{0}-{1}");
    ...
    /// {0} : entity name
    /// </remarks>
    public static CacheKey EntityAclRecordExistsCacheKey => new("AssetForge.aclrecord.exists.{0}");
    ...
    /// {1} : customer role ID
    /// </remarks>
    public static CacheKey PermissionAllowedCacheKey => new("AssetForge.permissionrecord.allowed.{0}-{1}", PermissionAllowedPrefix);
    ...
    /// {0} : permission system name
    /// </remarks>
    public static string PermissionAllowedPrefix => "AssetForge.permissionrecord.allowed.{0}";
    ...
    /// {0} : customer role ID
    /// </remarks>
    public static CacheKey PermissionRecordsAllCacheKey => new("AssetForge.permissionrecord.all.{0}", EntityCacheDefaults<PermissionRecord>.AllPrefix);
