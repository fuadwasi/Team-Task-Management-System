...
namespace AssetForge.Services.ExportImport.Help;
...
public partial class PropertyManager<T, L> where L : Language
{
    ...
    public PropertyManager(IEnumerable<PropertyByName<T, L>> defaultProperties, IEnumerable<PropertyByName<T, L>> localizedProperties = null, IList<L> languages = null)
    {
