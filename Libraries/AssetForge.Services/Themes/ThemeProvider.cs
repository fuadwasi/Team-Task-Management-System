...
namespace AssetForge.Services.Themes;
...
public partial class ThemeProvider : IThemeProvider
{
    ...
    public ThemeProvider(IAssetForgeFileProvider fileProvider)
    {
    ...
    protected virtual void Initialize()
    {
        ...
        lock (_locker)
        {
            ...
            var themeDirectoryPath = _fileProvider.MapPath(PluginDefaults.ThemesPath);
            foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath,
                         PluginDefaults.ThemeDescriptionFileName, false))
            {
