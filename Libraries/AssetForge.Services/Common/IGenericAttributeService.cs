...
public partial interface IGenericAttributeService
{
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    Task SaveAttributeAsync<TPropType>(BaseEntity entity, string key, TPropType value, int siteId = 0);
    ...
    /// </returns>
    Task<TPropType> GetAttributeAsync<TPropType>(BaseEntity entity, string key, int siteId = 0, TPropType defaultValue = default);
    ...
    /// The task result contains the attribute
    /// </returns>
    Task<TPropType> GetAttributeAsync<TEntity, TPropType>(int entityId, string key, int siteId = 0, TPropType defaultValue = default)
