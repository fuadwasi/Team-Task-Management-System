...
using AssetForge.Services.Html.CodeFormatter;
using System.Text.RegularExpressions;

namespace AssetForge.Services.Html;
...
public partial class BBCodeHelper : IBBCodeHelper
{
        ...
        bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
    {
        ...
        if (replaceUrl)
        {
            ...
            // format the URL tags: [url=https://www.radiowavehubcom]my site[/url]
            // becomes: <a href="https://www.radiowavehubcom">my site</a>
            text = _regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

            // format the URL tags: [url]https://www.radiowavehubcom[/url]
            // becomes: <a href="https://www.radiowavehubcom">https://www.radiowavehubcom</a>
        ...
        if (replaceImg)
            // format the img tags: [img]https://www.radiowavehubcom/Content/Images/Image.jpg[/img]
            // becomes: <img src="https://www.radiowavehubcom/Content/Images/Image.jpg">
