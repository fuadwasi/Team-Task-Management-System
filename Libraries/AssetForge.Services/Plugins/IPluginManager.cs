...
public partial interface IPluginManager<TPlugin> where TPlugin : class, IPlugin
{
    ...
    /// </returns>
    Task<IList<TPlugin>> LoadAllPluginsAsync(Customer customer = null, int siteId = 0);
    ...
    /// </returns>
    Task<TPlugin> LoadPluginBySystemNameAsync(string systemName, Customer customer = null, int siteId = 0);
    ...
    /// </returns>
    Task<IList<TPlugin>> LoadActivePluginsAsync(List<string> systemNames, Customer customer = null, int siteId = 0);
