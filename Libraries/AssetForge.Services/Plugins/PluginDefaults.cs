...
public static partial class PluginDefaults
{
    ...
    /// </remarks>
    public static CacheKey AdminNavigationPluginsCacheKey => new("AssetForge.plugins.adminnavigation.{0}", AdminNavigationPluginsPrefix);

    /// <summary>
    /// Gets a key pattern to clear cache
    /// </summary>
    public static string AdminNavigationPluginsPrefix => "AssetForge.plugins.adminnavigation.";
}